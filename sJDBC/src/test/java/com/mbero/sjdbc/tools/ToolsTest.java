...
public class ToolsTest {
    ...
    @Test
    public void testIsConfigurationSettedProperly() throws NotSettedFieldValueException {
	DBConnectionConfiguration configuration = new DBConnectionConfiguration();
	assertTrue(Tools.isConfigurationSettedProperly(configuration));
	...
	assertTrue(insertOperationsService.executeAnyInsertQueryFromParameter( insertQuery));
    }
